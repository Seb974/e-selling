...
const localdotenv = require('dotenv').config({path: './.env.local'});
...
Encore
    ...
    .configureDefinePlugin(options => {
        const env = localdotenv;
        if (env.error)
            throw env.error;
        options['process.env'].APP_IMAGES_FOLDER = JSON.stringify(env.parsed.APP_IMAGES_FOLDER);
